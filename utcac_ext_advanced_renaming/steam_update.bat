...
"D:\SteamLibrary\SteamApps\common\X Rebirth Tools\WorkshopTool.exe" update -path . -contentdef .\content_steam.xml -minor -changenote "Update via batch file. Change note will be updated soon."
del ext_01.cat
del ext_01.dat
@pause