...
-- Mid-Section definition
	...
	if index then
		print("Found -1 Entry in column "..index.." will set it to remaining width of "..(1195 - totalwidth).."pixels - Totalwidth="..totalwidth)
		menu.data.midtable_column_sizes[index] = 1195 - totalwidth
