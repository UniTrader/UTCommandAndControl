...
-- Mid-Section definition
	...
	if index then
		print("Found -1 Entry in column "..index.." will set it to remaining width of "..(1190 - totalwidth).."pixels - Totalwidth="..totalwidth)
		menu.data.midtable_column_sizes[index] = 1190 - totalwidth
