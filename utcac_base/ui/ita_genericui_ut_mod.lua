...
function menu.onShowMenu()
	...
	local middesc = setup:createCustomWidthTable({889, 150 , 150}, false, true, true, 1, 0, 0, Helper.tableOffsety - Helper.headerRow2Height/2 + Helper.headerRow2Offsetx, 445)--{Helper.e_DescWidth}
	--BOTTOM
	setup = Helper.createTableSetup(menu)
	local button1entry
	local button2entry
